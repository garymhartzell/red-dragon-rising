...
from engine.keyboard_input import init_window, set_status_text
...
def build_narrator() -> Narrator:
    ...
    sound = SoundManager()
    return Narrator(tts, sound, on_speak=set_status_text)
...
def main() -> None:
    ...
    narrator.say(
        ...
        "If you're using a screen reader like N V D A and it's talking over the "
        "game's own voice or announcing things like blank as you move around, "
        "you can press N V D A plus shift plus S, or N V D A plus shift plus Z "
        "on a laptop keyboard, to put your screen reader to sleep for this "
        "game. Press it again any time to wake it back up.",
        cache=True,
    )
